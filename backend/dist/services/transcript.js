...
export class TranscriptService {
     ...
     */
    static async extractTranscript(url) {
     ...
     */
    static async callExternalTranscriptAPI(url, platform) {
        try {
     ...
     */
    static async callYouTubeAPI(url) {
     ...
     */
    static async callInstagramAPI(url) {
        const headers = {
     ...
     */
    static generateTags(transcript, summary) {
     ...
     */
    static addContextualTags(content, tagScores) {
